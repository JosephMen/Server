...
import { ventaSchemaUtil } from '../Schemas/ventaSchema.js'
/**
...
export default class VentaService {
  ...
  /**
   * @param {Object} param0
   * @param {import('../Model/venta.js').default} param0.ventaModelo
   * @param {import('../../Producto/Services/productoVentaService.js').default} param0.productoVentaSer
   * @param {import('../../Existencia/Services/existenciaService.js').default} param0.existenciaSer
   */
  ...
  #doTransaction = async (func, params) => {
    if (!params) throw new BadArgumentsError('No se puede llamar a la funcion #doTransaction con params indefinido o null')
   ...
   */
  update = async ({ ventaIn, productosVenta }) => {
   ...
   */
  add = async ({ productosVenta, ventaIn }) => {
