...
export default class ImagenRelacion {
  ...
  deleteImagen = async ({ entidad, entidadId }) => {
    ...
    try {
      ...
      if (this.#logger) {
        this.#logger('Consulta hecha', consulta)
        this.#logger('Valores: ', [entidad, entidadId])
      }
  ...
  addImagen = async ({ entidad, imagenId, entidadId }) => {
    ...
    try {
      ...
      if (this.#logger) {
        this.#logger('Consulta hecha', consulta)
        this.#logger('Valores: ', [imagenId, entidadId])
      }
  ...
  getImagenId = async ({ entidad, id }) => {
    try {
      ...
      if (this.#logger) {
        this.#logger('Consulta hecha', consulta)
        this.#logger('Valores: ', [entidad, id])
      }
