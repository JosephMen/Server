...
import { validarBasicSchema, validarPartialBasicSchema } from '../Schemas/basicSchema.js'
import MimeTypes, { getExtension } from '../../Imagen/Utils/ImageMimeTypes.js'
import { messageSuccessCreator } from '../../Common/utils/messageCreator.js'

import IController from '../../Common/interfaces/controllers/IController.js'
...
export default class ProductoController extends IController {
  ...
  /**
     *
     * @param {{
     * productoService: import('../Services/productoService.js').default,
     * etiquetaService: import('../Services/EtiquetaService.js').default}}
     */
